...
class RegistrationForm:
    ...
    def build_ui(self):
        ...
        self.email_feedback = Label(self.root, text="", fg="red", bg="#F5F5F5", font=("Segoe UI", 14))
        ...
        self.password_feedback = Label(self.root, text="", fg="#666666", bg="#F5F5F5", font=("Segoe UI", 14))
    ...
    def send_verification_in_thread(self, is_resend=False):
        ...
        try:
            ...
            if success:
                ...
                error_msg += "\n3. Gmail 'Less secure apps' setting"
