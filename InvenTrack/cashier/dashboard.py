...
def get_current_username() -> str:
    ...
    try:
        ...
        row = cur.fetchone()
        return row[0] if row else _CURRENT_USERNAME
    finally:
        conn.close()
...
def create_dashboard_widgets(parent):
    ...
    # Col 1: Today’s transactions, pushed to the right of its wider column
